...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--port', default='23456', type=str)
        self.parser.add_argument('--max_iter', default=1, type=int)
        self.parser.add_argument('--workers', default=16, type=int)
        self.parser.add_argument('--max_epsilon', default=16, type=int)
        self.parser.add_argument('--model_target', default=2, type=int)
        self.parser.add_argument('--confidence', default=0, type=int)
        self.parser.add_argument('--alpha', default=1., type=float)
        self.parser.add_argument('--beta', default=1., type=float)
        self.parser.add_argument('--extra', action='store_true', help='if specified, use extra network')
